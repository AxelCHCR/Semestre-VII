...
void *thread_A(void *arg) {
    sleep(10);
    printf("Hilo A: Me dormi por 10 segundos.\n");

    pthread_t *thread_B = (pthread_t *)arg;
    printf("Hilo A: Esperando a que el Hilo B se despierte...\n");
    pthread_join(*thread_B, NULL);
    printf("Hilo A: El Hilo B se desperto.\n");
    return NULL;
}

void *thread_B(void *arg) {
    sleep(20);
    printf("Hilo B: Me desperte despues de 20 segundos.\n");

    pthread_t *thread_C = (pthread_t *)arg;
    printf("Hilo B: Esperando que el hilo C se despierte...\n");
    pthread_join(*thread_C, NULL);
    printf("Hilo B: El Hilo C termino.\n");
    return NULL;
}
